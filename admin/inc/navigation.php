...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-info text-white">
        ...
        <img src="<?php echo base_url ?>/uploads/NUST-logo-1-1024x1024.png" alt="NUST Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 2.5rem;height: 2.5rem;max-height: unset">
        <span class="brand-text font-weight-light">FCI CHATBOT DASHBOARD</span>
        </a>
        <!-- Sidebar -->
